...
class OrderService {
  ...
  async updateOrderStatus(orderID, newStatus) {
    ...
    if (newStatus === "Accepted") {
      ...
      socket.emit("order_accepted", order);
      console.log("Order broadcast emitted");
      await driverService.populateQueue(order, socket.emit.bind(socket));
    }
  }
